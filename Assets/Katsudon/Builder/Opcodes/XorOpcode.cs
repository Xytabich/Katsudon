...
{
	[OperationBuilder]
	public class XorOpcode : IOperationBuider
	{
		public int order => 0;
		...
		{
			BinaryOperatorExtension.ArithmeticBinaryOperation(method, ProcessOperation, BinaryOperator.LogicalXor, null, a, b);
		}
		...
		{
			var builder = new XorOpcode();
			container.RegisterOpBuilder(OpCodes.Xor, builder);
		}
	}
}