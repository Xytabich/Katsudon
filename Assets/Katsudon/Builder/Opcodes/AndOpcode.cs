...
{
	[OperationBuilder]
	public class AndOpcode : IOperationBuider
	{
		public int order => 0;
		...
		{
			BinaryOperatorExtension.ArithmeticBinaryOperation(method, ProcessOperation, BinaryOperator.LogicalAnd, null, a, b);
		}
		...
		{
			var builder = new AndOpcode();
			container.RegisterOpBuilder(OpCodes.And, builder);
		}
	}
}