...
namespace Katsudon.Builder.Extensions.UnityExtensions
{
	...
	public class SendMessageCall : IOperationBuider
	{
		...
		bool IOperationBuider.Process(IMethodDescriptor method)
		{
			...
			{
				/*
				var behaviours = GetComponents(typeof(UdonBehaviour));
				...
				*/
				...
				method.machine.AddExtern(
					CallGetComponents.GetExternName(methodInfo.DeclaringType == typeof(GameObject), true, nameof(GameObject.GetComponents)),
					behaviours,
					target.OwnType(),
		...
		{
			var builder = new SendMessageCall();
